...
public class AdminDashboardFrame extends javax.swing.JFrame {
    ...
    private void loadDashboardData() {
        List<Map<String, String>> staffList = StaffDAO.getAllStaff();
        
        DefaultTableModel model = new DefaultTableModel();
        model.setColumnIdentifiers(new String[]{"Mã NV", "Tên NV", "Chi Nhánh"});
        ...
        System.out.println("✅ Tải Tổng Quan: " + staffList.size() + " nhân viên");
    }
    ...
    private void loadStaffData() {
        ...
        System.out.println("✅ Tải Nhân Viên: " + staffList.size() + " bản ghi");
    }
    ...
    private void loadBranchData() {
        List<Map<String, String>> branchList = BranchDAO.getAllBranches();
        
        DefaultTableModel model = new DefaultTableModel();
        model.setColumnIdentifiers(new String[]{"Mã CN", "Tên CN", "Thành phố"});
        ...
        System.out.println("✅ Tải Chi Nhánh: " + branchList.size() + " bản ghi");
    }
